...
async function testGameMoves() {
  ...
  try {
    ...
    // Player 1 makes third move (top-right) - should win
    ...
    console.log("✅ Game status:", move3.data.data.game.status);
    console.log("✅ Winner:", move3.data.data.game.winner?.username);
    console.log("✅ Final board:", move3.data.data.game.board);
  } catch (error) {
    console.log(
...
async function testUserStats() {
  ...
  try {
    ...
    console.log("  - Games played:", user1.data.data.gamesPlayed);
    console.log("  - Games won:", user1.data.data.gamesWon);
    console.log("  - Win rate:", user1.data.data.winRate + "%");
    console.log("  - ELO rating:", user1.data.data.eloRating);
    ...
    console.log("  - Games played:", user2.data.data.gamesPlayed);
    console.log("  - Games won:", user2.data.data.gamesWon);
    console.log("  - Win rate:", user2.data.data.winRate + "%");
    console.log("  - ELO rating:", user2.data.data.eloRating);
  } catch (error) {
    console.log(
